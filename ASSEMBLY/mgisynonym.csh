...
(@synTypeKey, 10, null, 'synonym', 'synonym used in community', 0, 1086, 1086, getdate(), getdate())
insert into MGI_SynonymType 
values(@synTypeKey + 1, 10, null, 'nomenclature history', 'synonym due to nomenclature changes', 0, 1086, 1086, getdate(), getdate())
...
insert into MGI_SynonymType 
values(@synTypeKey, 21, 1, 'Author', 'synonymn the author used', 1, ${CREATEDBY}, ${CREATEDBY}, getdate(), getdate())
insert into MGI_SynonymType 
values(@synTypeKey + 1, 21, 1, 'Other', 'other', 0, ${CREATEDBY}, ${CREATEDBY}, getdate(), getdate())

...
results = db.sql('''
select distinct mm._marker_key, mm.symbol, p1.value, p2.value as nssymbol, p3.value as accid, o._organism_key, o.commonname
from MRK_Marker m, MGI_Relationship r,
MGI_Relationship_Property p1, MGI_Organism o,
MGI_Relationship_Property p2, MGI_Relationship_Property p3, MRK_Marker mm
where r._Object_key_2 = m._Marker_key
and r._Category_key = 1004
...
and r._Relationship_key = p2._Relationship_key
and p2._PropertyName_key = 12948291
and o._Organism_key = mm._Organism_key 
and lower(p2.value) = lower(mm.symbol)

...
select m._marker_key, m._organism_key, mm.commonname, m.symbol, a.accid
from markers mm, 
...
--that are also in MGI_Relationship EC (1004)
...
select m._organism_key, m.symbol, o.commonname
from MRK_Marker m, MGI_Organism o
where m._organism_key not in (1,10,11,13,40,63,84,94,95)
and m._organism_key = o._organism_key
group by m._organism_key, m.symbol, o.commonname having count(*) > 1
)
select m._marker_key, m._organism_key, mm.commonname, m.symbol, a.accid

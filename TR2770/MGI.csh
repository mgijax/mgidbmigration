...
/usr/local/mgi/dbutils/mgidbutilities/current/bin/dev/reconfig_mgd.csh ${MGDDB}
/usr/local/mgi/dbutils/mgidbutilities/current/bin/dev/reconfig_nomen.csh ${NOMENDB}
/usr/local/mgi/dbutils/mgidbutilities/current/bin/dev/reconfig_strains.csh ${STRAINSDB}

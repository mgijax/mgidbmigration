...
select count(e.*) from VOC_Annot v, VOC_Evidence e where v._AnnotType_key = 1016 and v._Annot_key = e._Annot_key;
select count(e.*) from VOC_Annot v, VOC_Evidence e where v._AnnotType_key = 1023 and v._Annot_key = e._Annot_key;

...
# must manually configure RELOAD_GENEMODELS=true
date | tee -a ${LOG}
...
# The scripts were created in https://mgi-jira.atlassian.net/browse/B39-354
# The TR directory where scripts reside (and also see readme)
# /mgi/all/wts_projects/13300/13349/Build39/GeneTraps/b39_gt_coords
...
# DATA: from mgigff3 file which is at ${FTPROOT}/pub/mgigff3/MGIlgff3.gz
# and is generated by mgigff3/bin/refresh above
# Must manually configure straingenemodelload B6_ONLY=FALSE
date | tee -a ${LOG}

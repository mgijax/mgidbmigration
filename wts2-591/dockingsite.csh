...
-- docking site examples : i.e. allele relationships
--select a._allele_key, a._marker_key,
select a.symbol as alleleSymbol, a1.accid as alleleID,
...
mgi_relationship mr, mgi_relationship_category mrs
...
--and a.symbol in ('Gt(ROSA)26Sor<tm1(CAG-Kcnj11*,-GFP)Nich>')

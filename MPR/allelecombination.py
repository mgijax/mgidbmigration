...
results = db.sql('select g._Genotype_key, alleleState = t1.term, compound = t2.term, allele1 = a1.symbol, allele2 = a2.symbol, ' +
	...
	'from GXD_AllelePair g, VOC_Term t1, VOC_Term t2, ALL_Allele a1, ALL_Allele a2, ACC_Accession c1, ACC_Accession c2, ACC_Accession c3, MRK_Marker m ' + \
	...
	'from GXD_AllelePair g, VOC_Term t1, VOC_Term t2, ALL_Allele a1, ACC_Accession c1, ACC_Accession c3, MRK_Marker m ' + \
	'where g._PairState_key = t1._Term_key ' + \
	'and g._Compound_key = t2._Term_key ' + \
	'and g._Allele_key_1 = a1._Allele_key ' + \

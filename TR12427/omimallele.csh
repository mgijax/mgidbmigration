...
-- omim-to-allele
--
select a1.accID as omimid, 
       a3.accID as doid, 
       a4.accID as alleleid,
       a5.accID as refid,
       t1.term as qualifer,
...
--from VOC_Annot v, VOC_Evidence e,
	--ACC_Accession a1, VOC_Term oo, 
        --ACC_Accession a4, ACC_Accession a5,
        --VOC_Term t1, VOC_Term t2, MGI_User u1
...
select count(e.*) from VOC_Annot v, VOC_Evidence e where v._AnnotType_key = 1012 and v._Annot_key = e._Annot_key;
select count(e.*) from VOC_Annot v, VOC_Evidence e where v._AnnotType_key = 1021 and v._Annot_key = e._Annot_key;

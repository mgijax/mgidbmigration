...
#
# Migration for TR12459 GB Seqload failed during post processing
#	needs update to SP
# (part 1 - optionally load dev database. etc)
#
# Products:
#
# mgidbmigration : trunk
# pgmgddbschema : trunk
...
echo "--- Recreate PRB_ageMinMax ---"
${PG_MGD_DBSCHEMADIR}/procedure/PRB_ageMinMax_drop.object
${PG_MGD_DBSCHEMADIR}/procedure/PRB_ageMinMax_create.object

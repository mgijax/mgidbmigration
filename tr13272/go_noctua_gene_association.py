...
# GAF 2.2
#
fp = reportlib.init('go_noctua_gene_association', fileExt = '.mgi', printHeading = None)
fp.write('!gaf-version: 2.2\n')
fp.write('!generated-by: MGI\n')
fp.write('!date-generated: %s\n' % (mgi_utils.date("%Y-%m-%d")))

fp2 = reportlib.init('go_noctua_gene_association_pro', fileExt = '.mgi', printHeading = None)

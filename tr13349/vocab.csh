...
insert into VOC_Term values(nextval('voc_term_seq'), 169,'precursor protein', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 169), 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 169,'precursor form', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 169), 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 169,'kda precursor', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 169), 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 169,'kilodalton precursor', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 169), 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 169,'peptide precursor', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 169), 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 169,'single chain precursor', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 169), 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 169,'hormone precursor', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 169), 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 169,'protein precursor', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 169), 0, 1001, 1001, now(), now());
...
insert into VOC_Term values(nextval('voc_term_seq'), 170,'pre-processed', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 170), 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 170,'pre-processing', null, null, (select max(sequenceNum) + 1 from voc_term where _vocab_key = 170), 0, 1001, 1001, now(), now());

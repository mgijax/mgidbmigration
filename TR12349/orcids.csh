...
SELECT _User-key, _UserType_key, _UserStatus_key, login, name, null, creation_date, modification_date
FROM MGI_User_old
;

UPDATE MGI_User SET orcID = 'http://orcid.org/0000-0001-7476-6306' WHER _User_key = 1072;

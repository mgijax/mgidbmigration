...
${PG_DBUTILS}/bin/bcpin.csh ${PG_DBSERVER} ${PG_DBNAME} BIB_Workflow_Tag ${DBUTILS}/mgidbmigration/LitTriage/datasets wf_status_tumor.bcp ${COLDELIM} ${LINEDELIM} mgd | tee -a ${LOG}

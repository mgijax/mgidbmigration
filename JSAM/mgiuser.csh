...
insert into MGI_User values (1107, @piKey, @inactiveKey, "mtd", "Muriel Davisson", 1000, 1000, getdate(), getdate())
insert into MGI_User values (1108, @curKey, @inactiveKey, "gxd editor", "Anonymous GXD Editor", 1000, 1000, getdate(), getdate())

...
insert into VOC_Term values(nextval('voc_term_seq'), 172, 'Not Specified', 'Not Appl', null, 1, 0, 1001, 1001, now(), now());
insert into VOC_Term values(nextval('voc_term_seq'), 172, 'Not Applicable', 'Not Spec' , null, 2, 0, 1001, 1001, now(), now());

...
#
# files generated by GO:
# noctua_mgi.gpad
# mgi.gpad : they are working on a new GPAD 2.0 spec
#
# not the same format as mgi.gpad created by MGI
# for example:  field 3
# noctua_mgi.gpad (generated by GO): qualifier (ex. is_active_in)
# mgi.gpad (genereated by GO):   they are working on a new GPAD 2.0 spec
# mgi.gpad (genereated by MGI):  RO:
#
# from:  MGI   MGI:xxx qualifier
# to  :  MGI:MGI:xxx   RO:
#
# we will have to change gomousenoctua to use new GPAD 2.0 spec
# that is, should match qcreports_db/daily/GO_gene_association.py
#

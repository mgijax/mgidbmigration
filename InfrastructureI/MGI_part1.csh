...
#
# Migration for Infrastructure I project -- 
# (part 1 - optionally load dev database. ect)
...
echo '---Drop Stored Procedures' | tee -a ${LOG}
cat - <<EOSQL | ${MGI_DBUTILS}/bin/doisql.csh ${MGD_DBSERVER} ${MGD_DBNAME} $0

use ${MGD_DBNAME}
go

drop procedure MGI_deletePrivateData
go
